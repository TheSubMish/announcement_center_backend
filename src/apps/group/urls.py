...
from .views import (
    ...
    ListGroupMemberView,
    CreateGroupCategoryView,
    ListGroupCategoryView,
)
...
urlpatterns = [
    ...
    path('member/<uuid:pk>/role/change/',ChangeMemberRoleView.as_view(),name='change-member-role-api'),
    path('<uuid:pk>/list/member/',ListGroupMemberView.as_view(),name='list-group-member-api'),
    path('category/create/',CreateGroupCategoryView.as_view(),name='create-group-category-api'),
    path('category/list/',ListGroupCategoryView.as_view(),name='list-group-category-api'),
]